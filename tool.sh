...
sudo cp ${USER_HOME}/go/bin/{unew,httprobe,xsschecker,qsreplace,httpx,dalfox,Gxss,katana,waybackurls,bxss,freq,hakrawler,gauplus,assetfinder,urlprobe} /usr/local/bin/
